...
##### 내가 몰라요. 그니까 틀린거 있으면 지적 좀 #####
##### 스프링에서도 마찬가지였겠지만 학교 과제의 코딩류와 다른 점이 분명 있음. #####
...
##### 특정 조건이 발생 -> 이하 코드 실행. 노드JS 코드는 거의 다 이 패턴. #####

## 이거 쫌 쉽게 감 잡기 위해 비슷한 경우가 수업 때 있었는데 함 설명##
...
##### 이제 위에서 언급한대로 " 'connect'라는 이벤트를 받으면 이하 콜백함수를 실행하라 " 알 수 있죠 ######
...
##### 이 이벤트 받아서 처리하는 부분은 app.js에 있었죠? #####
